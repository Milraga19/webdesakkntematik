<section class="h-100 w-100 bg-gradient-orange" style="box-sizing: border-box">
        ...
        <div class="list-footer">
            <div class="row gap-md-0 gap-3">
                <div class="col-lg-6 col-md-6">
                    <div class="">
                        ...
                        <nav class="list-unstyled">
                            <p>Website Resmi Desa Tanjung Tiram Sebagai media komunikasi, publikasi dan
                                transparansi
                                Pemerintah Desa
                            </p>
                        </nav>
                ...
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title">Kontak Desa</h2>
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="https://maps.app.goo.gl/ZQYqkKXuf6yw6ZJr6" class="list-menu">Lokasi</a>
                        </li>
                        <li class="list-space">
                            <a href="https://wa.me/+6282189378465" class="list-menu">WA</a>
                        </li>
                    </nav>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title">Kontak Penting</h2>
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="#" class="list-menu">Puskesmas</a>
                        </li>
                        <li class="list-space">
                            <a href="#" class="list-menu">Polsek</a>
                        </li>
                    </nav>
                </div>
            </div>
        ...
        <div class="border-color info-footer">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                ...
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <p style="margin: 0">Copyright © 2021 KKN Tematik UHO 2021</p>
                </nav>
            </div>
        </div>
    </div>
