            ...
            <section class="h-100 w-100 bg-white" style="box-sizing: border-box center">
                <div class="content-2-1 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
                    <div class="text-center title-text">
                        <h1 class="text-title">KKN Tematik Menu</h1>
                        ...
                        <div class="row">
                            <div class="col-lg-4 column">
                                <div class="card" style="width: 18rem; margin-left: auto; margin-right: auto;">
                                    <div class="card-body">
                                        <h5 class="card-title">Tim KKN Tematik</h5>
                                        <a href="timkkn.php" class="btn btn-card text-white">Klik Disini</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 column">
                                <div class="card" style="width: 18rem; margin-left: auto; margin-right: auto;">
                                    <div class="card-body">
                                        <h5 class="card-title">Program KKN Tematik</h5>
                                        <a href="programkkn.php" class="btn btn-card text-white">Klik Disini</a>
                                    </div>
                                </div>
                            </div>
                        </div>
