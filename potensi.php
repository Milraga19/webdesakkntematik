            ...
            <section class="h-100 w-100 bg-white" style="box-sizing: border-box center">
                <div class="content-2-1 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
                    <div class="text-center title-text">
                        <h1 class="text-title">Potensi Desa</h1>
                        <p class="text-caption" style="margin-left: 3rem; margin-right: 3rem">
                            Berikut ini Potensi desa dari Desa Tanjung Tiram
                        </p>
                    </div>
                    <div class="grid-padding text-center">
                        <div class="row">
                            ...
                            $tampil = mysqli_query($koneksi, "SELECT * from potensidesa");

                            while ($row = mysqli_fetch_array($tampil)) {
                            ?>
                                <div class="col-lg-4 column">
                                    <div class="card" style="width: 20rem; height: 40rem; margin-left: auto; margin-right: auto;">
                                        <img class="card-img-top" src="admin/upload/<?= $row["gambarpotensi"]; ?>" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $row["judulpotensi"]; ?></h5>
                                            <p class="card-text"><?= $row["deskripsipotensi"]; ?>
                                            </p>
                                            <a href="showpotensi.php?id=<?= $row["id"]; ?>" class="btn btn-card text-white">Baca Selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
                            <!-- <div class="col-lg-4 column">
                                <div class="card" style="width: 18rem; margin-left: auto; margin-right: auto;">
                                    <img class="card-img-top" src="img/default-berita.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="btn btn-card text-white">Baca Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 column">
