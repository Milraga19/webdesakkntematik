...
<head>
    ...
    <meta name="keywords" content="Sistem Informasi Desa, Potensi Desa, Berita Desa, Pengaduan, KKN Tematik UHO 2021, visi misi desa tanjung tiram" />
                ...
                <div class="content-3-1 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
                    <div class="d-flex flex-lg-row flex-column align-items-center">
                        ...
                        <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-center">
                            <h2 class="title-text">Visi Misi Desa</h2>
                            <div class="p-0 m-0">
                                <div class class="list-unstyled" style="margin-bottom: 2rem">
                                    <h5>Visi Desa</h5>
                                    <p class="text-caption">Mewujudkan Tanjung Tiram Sejahtera Melalui Pemanfaatan
                                        Potensi Sumberdaya Desa</p>
                                    <h5>Misi Desa</h5>

                                    <ol>
                                        <li class="text-caption" style="margin-bottom: 5px;">Memperkuat Sistem tata
                                            kelola Pemerintah yang
                                            profesional dan bebas KKN</li>
                                        <li class="text-caption" style="margin-bottom: 5px;">Meningkatkan infrastruktur
                                            Desa dengan mempertimbangkan
                                            resiko perubahan
                                            iklim</li>
                                        <li class="text-caption" style="margin-bottom: 5px;">Meningkatkan sarana dan
                                            prasarana ekonomi desa</li>
                                        <li class="text-caption" style="margin-bottom: 5px;">Meningkatkan partisipasi
                                            masyarakat dalam pembangunan
                                            desa</li>
                                        <li class="text-caption" style="margin-bottom: 5px;">Meningkatkan potensi sosial
                                            Budaya Desa</li>
                                    </ol>
