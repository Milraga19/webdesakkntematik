...
?>
    ...
    <head>
        ...
        <title>Tanjung Tiram | Statistik Desa</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Statistik Desa</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <h4 class="m-0 text-dark">Demografi</h4>
                        <div class="row">
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $row["data"]; ?></td>
                                            <td><?= $row["jumlah"]; ?></td>
                                            <td><a class="btn btn-secondary" href="editstat.php?id=<?php echo $row['id']; ?>&btn=update">Edit</a></td>
                                        </tr>
                                    </tbody>
                                    <?php $i++; ?>
                                <?php } ?>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Agama</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Pendidikan</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Pekerjaan</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Dusun</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Perkawinan</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Kaum Dhuafa</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">Pemilik Usaha Kecil (PUK)</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Small boxes (Stat box) -->
                        <h4 class="m-0 text-dark">TPA Desa</h4>
                        <div class="row">
                            <table class="table table-bordered" style="margin: 10px 0;">
                                <thead>
                                    <tr>
