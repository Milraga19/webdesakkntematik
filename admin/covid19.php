...
?>
    ...
    <head>
        ...
        <title>Tanjung Tiram | Covid 19</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <a class="btn btn-primary" href="covid19add.php">Tambah Data</a>
                        <div class="row">
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            <th scope="row"><?= $i; ?></th>
                                            <td><?= $row["tglupload"]; ?></td>
                                            <td><img src="upload/<?= $row["gambarcovid"] ?>" width="100" alt="news-image"></td>
                                            <td><a class="btn btn-danger" href="hapus_covid.php?id=<?php echo $row['id']; ?>&gambarcovid=<?php echo $row['gambarcovid']; ?>">X</a><a class="btn btn-secondary" href="editcovid.php?id=<?php echo $row['id']; ?>&btn=update">Edit</a></td>
